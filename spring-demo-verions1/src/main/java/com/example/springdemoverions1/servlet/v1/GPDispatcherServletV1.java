package com.example.springdemoverions1.servlet.v1;

import com.example.springdemoverions1.annotation.*;
...
@Component
public class GPDispatcherServletV1 extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        //2、扫描相关的类
        doScanner("com.example.springdemoverions1.demo");
    ...
    private void doDispatch(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        for (int i = 0; i < parameterTypes.length; i ++) {
            ...
            if(parameterType == HttpServletRequest.class){
                ...
                boolean annotationPresent = parameterType.isAnnotationPresent(GPRequestParam.class);
