package com.cloud.service.datasource.defaults;
...
import com.cloud.service.datasource.BaseDatabaseConfiguration;
import com.cloud.service.properties.DatabaseProperties;
...
/*    @Primary
    ...
    public SqlSessionFactory getSqlSessionFactory(@Qualifier(DATABASE_PREFIX + "DruidDataSource") DataSource dataSource) throws Exception {
