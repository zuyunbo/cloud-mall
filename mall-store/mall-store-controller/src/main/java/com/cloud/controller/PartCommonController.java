 ...
 */
@RestController
@RequestMapping("/api/partCommon")
@Api(tags="PartCommon")
public class PartCommonController {
    @Autowired
    private PartCommonService partCommonService;
    ...
    public Object page(PartCommonParam queryParam){
        PageInfo pageInfo = partCommonService.pageQuery(queryParam);
    ...
    public Object remove(@PathVariable long id) {
        int result = partCommonService.remove(id);
    ...
    @ApiOperation("保存")
    public Object save(@RequestBody PartCommon entity) {
        int result = partCommonService.save(entity);
    ...
    @ApiOperation("修改")
    public Object update(@RequestBody PartCommon entity) {
        int result = partCommonService.update(entity);
    ...
    public Object detail(@PathVariable long id) {
        PartCommon entity = partCommonService.getById(id);
